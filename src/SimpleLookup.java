...
public class SimpleLookup {
    private final BTree<String, String> locationIndex;
    private final HashTable<String, String> nameToId;
    private final HashTable<String, String> requestIndex;
    private final HashTable<String, String> resourceIndex;
